 ...
 */
public class WebServiceActivity extends BpmnActivity {
  ...
  public WebServiceActivity(String wsdl, Operation operation) {
    this(new CxfWebServiceClient(wsdl), operation);
  }
