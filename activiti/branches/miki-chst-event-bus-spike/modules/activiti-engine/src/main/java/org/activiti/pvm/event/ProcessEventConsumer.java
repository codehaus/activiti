...
/**
 * A process event handler is responsible for handling {@link ProcessEvent}s
...
public interface ProcessEventConsumer<T extends ProcessEvent> {
   ...
   * are only being sent to handlers they subscribed for the type of event. If
   * more than one handler is registered to receive a certain type of event,
