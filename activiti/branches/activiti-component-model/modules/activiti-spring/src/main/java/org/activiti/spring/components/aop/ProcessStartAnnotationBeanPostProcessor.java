...
/**
 * Proxies beans with methods annotated with {@link org.activiti.engine.annotations.StartProcess}.
 * If the method is invoked successfully, the process described by the annotaton is created.
 * Parameters passed to the method annotated with {@link org.activiti.engine.annotations.ProcessVariable}
