...
import org.activiti.spring.components.registry.*;
...
/**
 * bean post processor is responsible for registering all beans that have the {@link ActivitiState} annotation.
 *
 * @author Josh Long
 * @since 5.3
 */
public class ActivitiStateAnnotationBeanPostProcessor implements BeanPostProcessor, BeanClassLoaderAware, BeanFactoryAware, InitializingBean, Ordered {
	...
	public Object postProcessAfterInitialization(final Object bean,
		...
		final org.activiti.engine.annotations.ActivitiComponent component = targetClass.getAnnotation(org.activiti.engine.annotations.ActivitiComponent.class);
