...
import org.activiti.impl.pvm.spi.EventActivityBehaviour;


/**
 * @author Tom Baeyens
 */
public class WaitState implements EventActivityBehaviour {
  ...
  @Override
  public void event(ActivityInstance activityInstance) {
