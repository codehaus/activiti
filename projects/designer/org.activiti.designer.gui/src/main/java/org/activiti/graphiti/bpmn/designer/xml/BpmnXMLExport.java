...
public class BpmnXMLExport {
	...
	private static boolean createBpmnXML(XMLStreamWriter xtw, Diagram diagram, IProject project, String parentDiagramName) {
		try {
	...
	private static void createXML(EObject object, XMLStreamWriter xtw, IProject project, String parentDiagramName) throws Exception {
	...
	private static void createSubProcessXML(XMLStreamWriter xtw, IProject project, String parentDiagramName, String subProcessId) throws Exception {
		IFile targetFile = project.getFile(String.format(ActivitiBPMNDiagramConstants.DIAGRAM_FOLDER + "%s.%s"
				+ ActivitiBPMNDiagramConstants.DIAGRAM_EXTENSION, parentDiagramName, subProcessId));
