...
public class CustomPropertyImpl extends BaseElementImpl implements CustomProperty {
	...
	/**
	 * The default value of the '{@link #getComplexValue() <em>Complex Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getComplexValue()
	 * @generated
	 * @ordered
	 */
	protected static final byte[] COMPLEX_VALUE_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getComplexValue() <em>Complex Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getComplexValue()
	 * @generated
	 * @ordered
	 */
	protected byte[] complexValue = COMPLEX_VALUE_EDEFAULT;
	...
	public void setSimpleValue(String newSimpleValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.CUSTOM_PROPERTY__SIMPLE_VALUE,
					oldSimpleValue, simpleValue));
	}
	 ...
	 * @generated
	 */
	public void setComplexValue(byte[] newComplexValue) {
		byte[] oldComplexValue = complexValue;
		complexValue = newComplexValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.CUSTOM_PROPERTY__COMPLEX_VALUE,
					oldComplexValue, complexValue));
	}
	...
	public void eUnset(int featureID) {
		...
		case Bpmn2Package.CUSTOM_PROPERTY__SIMPLE_VALUE:
			...
			return;
		case Bpmn2Package.CUSTOM_PROPERTY__COMPLEX_VALUE:
			setComplexValue(COMPLEX_VALUE_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case Bpmn2Package.CUSTOM_PROPERTY__COMPLEX_VALUE:
			return COMPLEX_VALUE_EDEFAULT == null ? complexValue != null : !COMPLEX_VALUE_EDEFAULT.equals(complexValue);
		}
