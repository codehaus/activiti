...
public class Bpmn2Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    ...
    case Bpmn2Package.MAIL_TASK: {
      ...
      if (result == null)
        result = caseTask(mailTask);
      if (result == null)
        result = caseActivity(mailTask);
      if (result == null)
        result = caseInteractionNode(mailTask);
      if (result == null)
        result = caseFlowNode(mailTask);
      if (result == null)
        result = caseFlowElement(mailTask);
      if (result == null)
        result = caseBaseElement(mailTask);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case Bpmn2Package.FIELD_EXTENSION: {
      ...
      if (result == null)
        result = caseBaseElement(fieldExtension);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case Bpmn2Package.COMPLEX_DATA_TYPE: {
      ...
      if (result == null)
        result = caseBaseElement(complexDataType);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case Bpmn2Package.DATA_GRID: {
      ...
      if (result == null)
        result = caseComplexDataType(dataGrid);
      if (result == null)
        result = caseBaseElement(dataGrid);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case Bpmn2Package.DATA_GRID_ROW: {
      ...
      if (result == null)
        result = caseBaseElement(dataGridRow);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case Bpmn2Package.DATA_GRID_FIELD: {
      ...
      if (result == null)
        result = caseBaseElement(dataGridField);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
