...
public interface CustomProperty extends BaseElement {
	...
	/**
	 * Returns the value of the '<em><b>Complex Value</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Complex Value</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Complex Value</em>' attribute.
	 * @see #setComplexValue(byte[])
	 * @see org.eclipse.bpmn2.Bpmn2Package#getCustomProperty_ComplexValue()
	 * @model
	 * @generated
	 */
	byte[] getComplexValue();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.CustomProperty#getComplexValue <em>Complex Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Complex Value</em>' attribute.
	 * @see #getComplexValue()
	 * @generated
	 */
	void setComplexValue(byte[] value);
