...
import org.activiti.designer.common.registry.RegistryRegistry;
...
public class XmlAdapterFactory extends AbstractAdapterFactory {
	...
	protected INodeAdapter createAdapter(INodeNotifier target) {
		if (document == null) throw new RuntimeException("The document property of the ActivitiElementDomAdapterFactory is not initialized");
	...
	void register(XmlAdapter activitiElementDomAdapter) {
		adapterRegistry.put(activitiElementDomAdapter.getSemanticElement(), activitiElementDomAdapter);
	}
	
	void unregister(XmlAdapter activitiElementDomAdapter) {
		adapterRegistry.remove(activitiElementDomAdapter.getSemanticElement());
	}
	
	XmlAdapter getRegisteredAdapterFor(SemanticElement activitiElement) {
		return (XmlAdapter)adapterRegistry.get(activitiElement);
	}
