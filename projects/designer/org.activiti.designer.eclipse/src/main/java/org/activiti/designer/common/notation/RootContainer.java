...
import org.activiti.designer.common.editor.CreationFactory;
...
public class RootContainer extends AbstractNotationElement implements NodeContainer {
	...
	protected void removeNode(PropertyChangeEvent evt) {
		SemanticElement activitiElement = (SemanticElement)evt.getOldValue();
		AbstractNotationElement notationElement = getRegisteredNotationElementFor(activitiElement);
		if (notationElement != null) {
			activitiElement.removePropertyChangeListener(notationElement);
